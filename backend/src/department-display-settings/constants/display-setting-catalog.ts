...
export const DEPARTMENT_DISPLAY_SETTINGS_CATALOG: DisplaySettingCatalogEntry[] = [
  ...
  { key: 'vision.showSection', section: 'Vision & Mission', label: 'Show Vision & Mission' },
  ...
  { key: 'programmes.showSection', section: 'Programs', label: 'Show Programs Section' },
  { key: 'labs.showSection', section: 'Laboratories', label: 'Show Laboratories Section' },
  { key: 'labs.showEquipment', section: 'Laboratories', label: 'Show Equipment List' },
  { key: 'research.showSection', section: 'Research', label: 'Show Research Section' },
  { key: 'research.showPublications', section: 'Research', label: 'Show Publications' },
  { key: 'research.showProjects', section: 'Research', label: 'Show Projects' },
  { key: 'research.showPatents', section: 'Research', label: 'Show Patents' },
  { key: 'research.showVideos', section: 'Research', label: 'Show Related Videos' },
  { key: 'highlights.showSection', section: 'Highlights', label: 'Show AI-Enabled Highlights' },
  { key: 'achievements.showSection', section: 'Achievements', label: 'Show Achievements Section' },
  { key: 'gallery.showSection', section: 'Gallery', label: 'Show Gallery Section' },
  { key: 'videos.showSection', section: 'Videos', label: 'Show Videos Section' },
  { key: 'downloads.showSection', section: 'Downloads', label: 'Show Downloads Section' },
  ...
  { key: 'statistics.showSection', section: 'Statistics', label: 'Show Department Statistics' },
  { key: 'contact.showSection', section: 'Contact', label: 'Show Contact Information' },
];
