...
function ColHeading({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: "18px", lineHeight: 1.2 }}>
      <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "17px", fontWeight: 700, color: "#ffffff", marginBottom: "8px", letterSpacing: "0.6px", textTransform: "uppercase" }}>
        {children}
      </div>
    ...
    <footer style={{ width: "100%", background: "#1e2570", color: "#ffffff", paddingTop: "56px" }}>
      ...
      >
        ...
        <motion.div variants={colVariants}>
          ...
          <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.6)", lineHeight: 1.6, margin: "0 0 14px" }}>
        ...
        <motion.div variants={colVariants}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "14px" }}>
            ...
            <a href="mailto:info@ksrmce.ac.in" style={{ fontSize: "14px", color: "rgba(255,255,255,0.7)", textDecoration: "none" }}>
              info@ksrmce.ac.in
            </a>
          </div>
      ...
      {/* BOTTOM BAR */}
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", marginTop: "44px", padding: "20px 0" }}>
        <div className="footer-bottom-inner" style={{ justifyContent: "center", flexDirection: "column", textAlign: "center", gap: "5px" }}>
          <span style={{ fontSize: "14px", color: "rgba(255,255,255,0.65)", fontWeight: 600 }}>
            © {currentYear} KSRM College of Engineering. All Rights Reserved.
          </span>
          <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.45)", letterSpacing: "0.4px" }}>
            A unit of Sri Kandula Obul Reddy Charities · Powered by Talent Trek Technologies
          </span>
        </div>
      </div>
    </footer>
