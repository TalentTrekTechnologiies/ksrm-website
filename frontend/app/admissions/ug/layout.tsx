...
export const metadata: Metadata = {
  ...
  openGraph: { title: "B.Tech Admissions | K.S.R.M. College of Engineering", description: "Undergraduate (B.Tech) admissions at K.S.R.M. College of Engineering, Kadapa - programmes, intake and process.", url: "/admissions/ug" },
}
