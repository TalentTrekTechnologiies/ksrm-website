    ...
    <section className="hero-section" style={{ position: "relative", width: "100%", height: "88vh", overflow: "hidden" }}>
      <style>{`
        ...
        @media (max-width: 768px) {
          .hero-section  { height: 92svh !important; min-height: 520px !important; }
          ...
          .hero-gradient { background: linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.65) 100%) !important; }
        }
      `}</style>
