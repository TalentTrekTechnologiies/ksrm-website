    ...
    <div dangerouslySetInnerHTML={{
      __html: `<!DOCTYPE html><html lang="en" data-scroll-behavior="smooth" class="font-sans arimo_bb082808-module__YDM0vq__variable"><head><meta charSet="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="preload" href="/_next/static/media/3206eb66b875a5b3-s.p.0newl065t398d.woff2" as="font" crossorigin="" type="font/woff2"/><link rel="preload" href="/_next/static/media/a079e02bba5bf7ab-s.p.0.s85e2kacc1m.woff2" as="font" crossorigin="" type="font/woff2"/><link rel="preload" href="/_next/static/media/aae5f0be330e13db-s.p.09~kfcksvwt3b.woff2" as="font" crossorigin="" type="font/woff2"/><link rel="preload" href="/_next/static/media/d23f31b94ad01e54-s.p.091biwio0g5wn.woff2" as="font" crossorigin="" type="font/woff2"/><link rel="preload" as="image" href="/ring.png"/><link rel="preload" as="image" href="/book.png"/><link rel="preload" as="image" href="/banner.png"/><link rel="preload" as="image" href="/logo.png"/><link rel="preload" as="image" href="/nba.png"/><link rel="preload" as="image" href="/naac.png"/><link rel="preload" as="image" href="/jntua.png"/><link rel="preload" as="image" href="/gnan.png"/><link rel="preload" as="image" href="/ksnr.png"/><link rel="stylesheet" href="/_next/static/chunks/0u-l-.84zqgxg.css" data-precedence="next"/><link rel="stylesheet" href="/_next/static/chunks/08r5p52~uyd_7.css" data-precedence="next"/><link rel="preload" as="script" fetchPriority="low" href="/_next/static/chunks/0sur~ccmg786l.js"/><script src="/_next/static/chunks/0am~qrn.2~amr.js" async=""></script><script src="/_next/static/chunks/06ni6111_fqel.js" async=""></script><script src="/_next/static/chunks/0piol93jdjrdh.js" async=""></script><script src="/_next/static/chunks/0ofc--.ubvo_z.js" async=""></script><script src="/_next/static/chunks/turbopack-0kk9ynu9gg9t3.js" async=""></script><script src="/_next/static/chunks/05fi3fb~3qmkl.js" async=""></script><script src="/_next/static/chunks/0mtwemt.1oqqp.js" async=""></script><script src="/_next/static/chunks/02fqch~ni_1x3.js" async=""></script><script src="/_next/static/chunks/0jprs_fd_n1y2.js" async=""></script><script src="/_next/static/chunks/0_tju3xznfr.o.js" async=""></script><meta name="next-size-adjust" content=""/><title>K.S.R.M College of Engineering</title><meta name="description" content="K.S.R.M College of Engineering, Kadapa — 40 years of engineering excellence. NAAC A++ | NBA Accredited | AICTE Approved"/><link rel="icon" href="/favicon.ico?favicon.0x3dzn~oxb6tn.ico" sizes="256x256" type="image/x-icon"/><script src="/_next/static/chunks/03~yq9q893hmn.js" noModule=""></script></head><body class="rajdhani_ab1774d9-module__PVobqq__variable arimo_bb082808-module__YDM0vq__variable antialiased" style="font-family:var(--font-arimo), Arial, sans-serif"><div hidden=""><!--$--><!--/$--></div><div style="position:fixed;inset:0;z-index:9999;background:#f4f3ef;display:flex;align-items:center;justify-content:center;opacity:1;transition:opacity 1.1s ease;pointer-events:auto"><div style="position:absolute;width:clamp(540px, 79vw, 990px);height:clamp(540px, 79vw, 990px);border-radius:50%;background:radial-gradient(circle, rgba(43,52,144,0.12) 0%, rgba(43,52,144,0) 70%);opacity:0;transition:opacity 1.5s ease"></div><div style="position:relative;width:clamp(396px, 72vw, 810px);height:clamp(396px, 72vw, 810px);transform:scale(1);opacity:1;transition:transform 0.35s ease"><img src="/ring.png" alt="" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;transition:all 2.3s cubic-bezier(0.16, 1, 0.3, 1);opacity:0;transform:translate(-90vw,0) rotate(-220deg) scale(0.5)"/><img src="/book.png" alt="" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;transition:all 2.3s cubic-bezier(0.16, 1, 0.3, 1);opacity:0;transform:translate(0,-90vh) scale(0.6);transition-delay:0.5s"/><img src="/banner.png" alt="" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;transition:all 2.3s cubic-bezier(0.16, 1, 0.3, 1);opacity:0;transform:translate(0,90vh) scale(0.6);transition-delay:1s"/></div></div><div style="background:#202a78;color:#fff;width:100%;overflow:hidden"><style>
        ...
        .adm-card:hover {
          ...
          box-shadow: 0 16px 36px rgba(43, 52, 144, 0.13);
          border-color: #D4A500;
        }
        .adm-card-icon {
          width: 48px;
        ...
        @media (max-width: 768px) {
          ...
          .adm-intro-section { padding: 48px 0; }
        }
      </style><section class="adm-hero"><style>
      ...
      </style><div class="responsive-container "><div><h1 class="adm-title" style="opacity:0;transform:translateY(28px)">Admissions</h1><p class="adm-subtitle" style="opacity:0;transform:translateY(28px)">Join KSRM College of Engineering</p></div></div></section><section class="adm-intro-section"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div><p class="adm-intro-text" style="opacity:0;transform:translateY(28px)">KSRM College of Engineering offers quality technical education through multiple academic pathways. Explore our undergraduate, postgraduate, and diploma programs designed to shape future engineers and innovators.</p><div class="adm-cards-grid"><div style="opacity:0;transform:translateY(28px)"><a style="text-decoration:none;display:block;height:100%" href="/admissions/ug"><div class="adm-card"><div class="adm-card-icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open" aria-hidden="true"><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg></div><h3 class="adm-card-title">UG Programs</h3><p class="adm-card-desc">B.Tech Undergraduate Programs</p></div></a></div><div style="opacity:0;transform:translateY(28px)"><a style="text-decoration:none;display:block;height:100%" href="/admissions/pg"><div class="adm-card"><div class="adm-card-icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-graduation-cap" aria-hidden="true"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"></path><path d="M22 10v6"></path><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"></path></svg></div><h3 class="adm-card-title">PG Programs</h3><p class="adm-card-desc">M.Tech &amp; MBA Programs</p></div></a></div><div style="opacity:0;transform:translateY(28px)"><a style="text-decoration:none;display:block;height:100%" href="/admissions/diploma"><div class="adm-card"><div class="adm-card-icon"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-award" aria-hidden="true"><path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"></path><circle cx="12" cy="8" r="6"></circle></svg></div><h3 class="adm-card-title">Diploma</h3><p class="adm-card-desc">Diploma Engineering Programs</p></div></a></div></div></div></div></section></main><!--$--><!--/$--><footer style="width:100%;background:#1e2570;color:#ffffff;padding-top:56px"><style>
