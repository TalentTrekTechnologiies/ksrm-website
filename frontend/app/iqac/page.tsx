...
export const metadata: Metadata = {
  ...
  description: "Information about IQAC at K.S.R.M College of Engineering",
}
  ...
  return (
    <main style={{ background: "#fff" }}>
      <section style={{
        ...
        <Container>
          <h1 style={{ fontSize: "2.5rem", margin: "0 0 20px", fontWeight: 700 }}>IQAC</h1>
      ...
      <section style={{ padding: "60px 20px", background: "#fff" }}>
        <Container>
          <p style={{ fontSize: "1rem", lineHeight: 1.8, color: "#555" }}>
            IQAC section content and information displayed here.
          </p>
        </Container>
      </section>
    </main>
