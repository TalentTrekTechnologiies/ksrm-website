...
export const metadata: Metadata = {
  ...
  openGraph: { title: "NAAC | K.S.R.M. College of Engineering", description: "NAAC accreditation information and documents for K.S.R.M. College of Engineering, Kadapa.", url: "/naac" },
}
