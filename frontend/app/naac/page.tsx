...
export default function DepartmentTemplate({ department }: DepartmentTemplateProps) {
  ...
  return (
    <main style={{ background: "#ffffff" }}>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/banners/${
            { cse: 'cse.jpg', ece: 'ece.webp', eee: 'eee.jpg', civil: 'civil.avif', mechanical: 'mechanical.jpg', 'humanities-sciences': 'hs.png', mba: 'mba.avif' }[department.slug] || 'cse.jpg'
          }')`,
          alignItems: 'flex-end',
          paddingBottom: '40px',
        }}
            ...
            {department.tagline && (
              <motion.p
                ...
                style={{
                  ...
                  margin: "16px 0 0", fontWeight: 300, maxWidth: '100%',
        ...
        <Container>
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              style={{
                color: "#555", fontSize: 17, lineHeight: 1.8, margin: 0,
              }}
            >
              {department.about}
            </motion.p>
      ...
      {department.aiHighlights && department.aiHighlights.length > 0 && (
          ...
          <Container>
            ...
            >
              <motion.h2
                ...
                style={{
                  fontFamily: "'Rajdhani', sans-serif", fontSize: "clamp(1.8rem, 3vw, 2.4rem)",
                  fontWeight: 700, color: "#1a1a2e", margin: "0 0 48px",
                }}
              >
                🤖 AI-Enabled Highlights
              </motion.h2>
              <div style={{
                ...
                {department.aiHighlights.map((highlight, idx) => (
                  <motion.div
                    key={idx}
                    variants={fadeUp}
                    style={{
                    ...
                    whileHover={{ transform: "translateY(-4px)", boxShadow: "0 12px 32px rgba(43, 52, 144, 0.1)" }}
                  >
                    <h3 style={{
                      fontFamily: "'Rajdhani', sans-serif",
                      fontSize: 18,
              ...
              <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 48, alignItems: "start" }}>
                ...
                <motion.div variants={slideInRight} style={{ paddingTop: 20 }}>
                  ...
                  {(department.hod.message || []).map((msg, idx) => (
                    <p key={idx} style={{ color: "#555", fontSize: 16, lineHeight: 1.8, margin: "0 0 16px" }}>
                      {msg}
                    </p>
                  ))}
                </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ padding: "16px" }}>
                      ...
                      <p
                        style={{
                          color: "#2B3490", fontSize: 13, fontWeight: 700,
                ...
                >
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 8 }}>
                    <div>
                      ...
                      <p style={{ color: "#1a1a2e", fontSize: 15, fontWeight: 600, margin: 0 }}>{prog.level}</p>
                    </div>
                    <div>
                      <p style={{ color: "#666", fontSize: 13, margin: "0 0 4px", textTransform: "uppercase", fontWeight: 600 }}>Intake</p>
                      <p style={{ color: "#1a1a2e", fontSize: 15, fontWeight: 600, margin: 0 }}>{prog.intake}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
