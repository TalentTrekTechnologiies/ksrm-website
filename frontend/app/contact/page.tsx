...
export default function Page() {
  return (
    <div dangerouslySetInnerHTML={{
      ...
      </style><section class="contact-hero"><style>
      ...
      </style><div class="responsive-container "><div><div class="contact-breadcrumb" style="margin-bottom:16px;text-shadow:0 2px 8px rgba(0,0,0,0.6)"><a href="/">Home</a><span>/</span><span>Contact Us</span></div><h1 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(2.2rem, 4.5vw, 3.6rem);font-weight:700;color:#fff;line-height:1.08;margin:0;text-shadow:0 2px 12px rgba(0,0,0,0.7);opacity:0;transform:translateY(28px)">Contact Us</h1><p style="color:rgba(255,255,255,0.85);font-size:18px;line-height:1.6;margin:16px 0 0;font-weight:300;max-width:100%;text-shadow:0 2px 8px rgba(0,0,0,0.6);opacity:0;transform:translateY(28px)">We&#x27;re here to help — reach out to us</p></div></div></section><section style="padding:72px 0;background:#ffffff"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div class="contact-main-grid"><div style="opacity:0;transform:translateY(28px)"><div class="contact-info-card"><div class="contact-info-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin" aria-hidden="true"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg></div><div class="contact-info-content"><h3>Address</h3><p>K.S.R.M. College of Engineering, Kadapa – 516 003, Andhra Pradesh, India</p></div></div><div class="contact-info-card"><div class="contact-info-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone" aria-hidden="true"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"></path></svg></div><div class="contact-info-content"><h3>Phone</h3><a href="tel:+91 9000073434">+91 9000073434</a></div></div><div class="contact-info-card"><div class="contact-info-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone" aria-hidden="true"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"></path></svg></div><div class="contact-info-content"><h3>Alternate</h3><a href="tel:08562 295972">08562 295972</a></div></div><div class="contact-info-card"><div class="contact-info-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone" aria-hidden="true"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"></path></svg></div><div class="contact-info-content"><h3>Alternate</h3><a href="tel:+91 8143731980">+91 8143731980</a></div></div><div class="contact-info-card"><div class="contact-info-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail" aria-hidden="true"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path><rect x="2" y="4" width="20" height="16" rx="2"></rect></svg></div><div class="contact-info-content"><h3>Email</h3><a href="mailto:ksrmcengg@yahoo.co.in">ksrmcengg@yahoo.co.in</a></div></div><div class="contact-info-card"><div class="contact-info-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail" aria-hidden="true"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"></path><rect x="2" y="4" width="20" height="16" rx="2"></rect></svg></div><div class="contact-info-content"><h3>Alternate</h3><a href="mailto:principal@ksrmce.ac.in">principal@ksrmce.ac.in</a></div></div></div><div class="contact-map" style="opacity:0;transform:translateY(28px)"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3863.125530584371!2d78.76410318567737!3d14.477480402447771!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bb373e15c65e6b7%3A0x2b13242197e9d9fa!2zS1NSTSDgsJXgsL7gsLLgsYfgsJzgsY0g4LCG4LCr4LGNIOCwh-CwguCwnOCwv-CwqOCxgOCwsOCwv-CwguCwl-CxjQ!5e0!3m2!1ste!2sin!4v1479195998208"></iframe></div></div></div></section><section style="padding:72px 0;background:#f7f8fa"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div><h2 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(1.8rem, 3vw, 2.4rem);font-weight:700;color:#1a1a2e;margin:0 0 24px;opacity:0;transform:translateY(28px)">Department Contacts</h2><div class="contact-departments-grid"><div class="contact-dept-card" style="opacity:0;transform:translateY(28px)"><h3>Principal Office</h3><p>Phone:</p><a href="tel:+91 9000073434">+91 9000073434</a><p>Email:</p><a href="mailto:principal@ksrmce.ac.in">principal@ksrmce.ac.in</a></div><div class="contact-dept-card" style="opacity:0;transform:translateY(28px)"><h3>Admissions Office</h3><p>Phone:</p><a href="tel:+91 8143731980">+91 8143731980</a><p>Email:</p><a href="mailto:ksrmcengg@yahoo.co.in">ksrmcengg@yahoo.co.in</a></div><div class="contact-dept-card" style="opacity:0;transform:translateY(28px)"><h3>Examination Section</h3><p>Phone:</p><a href="tel:08562 295972">08562 295972</a><p>Email:</p><a href="mailto:principal@ksrmce.ac.in">principal@ksrmce.ac.in</a></div><div class="contact-dept-card" style="opacity:0;transform:translateY(28px)"><h3>Training &amp; Placement</h3><p>Phone:</p><a href="tel:+91 9000073434">+91 9000073434</a><p>Email:</p><a href="mailto:principal@ksrmce.ac.in">principal@ksrmce.ac.in</a></div></div></div></div></section><section style="padding:48px 0;background:#ffffff"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div class="contact-hours-banner" style="opacity:0;transform:translateY(28px)"><h3>📅 Working Hours</h3><p style="margin:12px 0 0;font-size:16px">Monday to Saturday: 9:00 AM – 5:00 PM</p></div></div></section><section style="padding:48px 0;background:#f7f8fa;text-align:center"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div style="opacity:0;transform:translateY(28px)"><h3 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:18px;font-weight:700;color:#1a1a2e;margin:0 0 24px">Follow Us</h3><div class="contact-social"><a href="https://www.facebook.com/ksrmceofficial" target="_blank" rel="noopener noreferrer" class="contact-social-link" title="Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-share2 lucide-share-2" aria-hidden="true"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" x2="15.42" y1="13.51" y2="17.49"></line><line x1="15.41" x2="8.59" y1="6.51" y2="10.49"></line></svg></a><a href="https://twitter.com/ksrmceofficial" target="_blank" rel="noopener noreferrer" class="contact-social-link" title="Twitter"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart" aria-hidden="true"><path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"></path></svg></a><a href="https://www.instagram.com/ksrmceofficial" target="_blank" rel="noopener noreferrer" class="contact-social-link" title="Instagram"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-globe" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path><path d="M2 12h20"></path></svg></a><a href="https://www.youtube.com/ksrmceofficialmedia" target="_blank" rel="noopener noreferrer" class="contact-social-link" title="YouTube"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-music" aria-hidden="true"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg></a></div></div></div></section></main><!--$--><!--/$--><footer style="width:100%;background:#1e2570;color:#ffffff;padding-top:56px"><style>
