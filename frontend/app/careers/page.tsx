...
export default function Page() {
  return (
    <div dangerouslySetInnerHTML={{
      ...
      </style><section class="car-hero"><style>
      ...
      </style><div class="responsive-container "><div style="padding:72px 0;position:relative;z-index:1"><div><div class="car-breadcrumb"><a href="/">Home</a><span>/</span><span>Careers</span></div><h1 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(2.2rem, 4.5vw, 3.6rem);font-weight:700;color:#fff;line-height:1.08;margin:0;opacity:0;transform:translateY(28px)">Careers at KSRM</h1><p style="color:rgba(255,255,255,0.8);font-size:18px;line-height:1.6;margin:16px 0 0;font-weight:300;max-width:600px;opacity:0;transform:translateY(28px)">Join Our Team of Excellence</p></div></div></div></section><section style="padding:72px 0;background:#ffffff"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div><h2 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(1.8rem, 3vw, 2.4rem);font-weight:700;color:#1a1a2e;margin:0 0 24px;opacity:0;transform:translateY(28px)">Why Join KSRM?</h2><div class="car-whyjoin-grid"><div class="car-whyjoin-card" style="opacity:0;transform:translateY(28px)"><h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open" aria-hidden="true"><path d="M12 7v14"></path><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path></svg>Excellence in Education</h3><p>Join an institution recognized for academic excellence</p></div><div class="car-whyjoin-card" style="opacity:0;transform:translateY(28px)"><h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-zap" aria-hidden="true"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg>Research Opportunities</h3><p>Contribute to cutting-edge research initiatives</p></div><div class="car-whyjoin-card" style="opacity:0;transform:translateY(28px)"><h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users" aria-hidden="true"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><path d="M16 3.128a4 4 0 0 1 0 7.744"></path><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><circle cx="9" cy="7" r="4"></circle></svg>Supportive Culture</h3><p>Work in a collaborative and supportive environment</p></div><div class="car-whyjoin-card" style="opacity:0;transform:translateY(28px)"><h3><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2B3490" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-award" aria-hidden="true"><path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"></path><circle cx="12" cy="8" r="6"></circle></svg>Career Growth</h3><p>Access professional development and advancement opportunities</p></div></div></div></div></section><section style="padding:72px 0;background:#f7f8fa"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div><h2 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(1.8rem, 3vw, 2.4rem);font-weight:700;color:#1a1a2e;margin:0 0 24px;opacity:0;transform:translateY(28px)">Current Openings</h2><div class="car-openings-list"><div class="car-opening-card" style="opacity:0;transform:translateY(28px)"><p class="car-opening-title">Assistant Professor - CSE</p><p style="color:#666;font-size:14px;margin:0 0 8px"><span style="font-weight:600;color:#2B3490">Department:</span> <!-- -->Computer Science &amp; Engineering</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:16px"><p style="color:#666;font-size:13px;margin:0"><span style="font-weight:600;color:#2B3490">Qualification:</span> <!-- -->M.Tech/Ph.D. in Computer Science</p><p style="color:#666;font-size:13px;margin:0"><span style="font-weight:600;color:#2B3490">Experience:</span> <!-- -->0-2 years</p></div><button class="car-cta-button" style="margin-top:12px;margin-bottom:0;font-size:14px;padding:12px 24px">Apply Now</button></div><div class="car-opening-card" style="opacity:0;transform:translateY(28px)"><p class="car-opening-title">Lab Technician - ECE</p><p style="color:#666;font-size:14px;margin:0 0 8px"><span style="font-weight:600;color:#2B3490">Department:</span> <!-- -->Electronics &amp; Communication</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:16px"><p style="color:#666;font-size:13px;margin:0"><span style="font-weight:600;color:#2B3490">Qualification:</span> <!-- -->Diploma/B.Tech in Electronics</p><p style="color:#666;font-size:13px;margin:0"><span style="font-weight:600;color:#2B3490">Experience:</span> <!-- -->2-3 years</p></div><button class="car-cta-button" style="margin-top:12px;margin-bottom:0;font-size:14px;padding:12px 24px">Apply Now</button></div><div class="car-opening-card" style="opacity:0;transform:translateY(28px)"><p class="car-opening-title">Administrative Officer</p><p style="color:#666;font-size:14px;margin:0 0 8px"><span style="font-weight:600;color:#2B3490">Department:</span> <!-- -->Administration</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:16px"><p style="color:#666;font-size:13px;margin:0"><span style="font-weight:600;color:#2B3490">Qualification:</span> <!-- -->Bachelor&#x27;s Degree</p><p style="color:#666;font-size:13px;margin:0"><span style="font-weight:600;color:#2B3490">Experience:</span> <!-- -->3-5 years</p></div><button class="car-cta-button" style="margin-top:12px;margin-bottom:0;font-size:14px;padding:12px 24px">Apply Now</button></div></div></div></div></section><section style="padding:56px 0;background:linear-gradient(135deg, #2B3490, #1e2570);text-align:center"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div style="opacity:0;transform:translateY(28px)"><h2 style="color:#fff;font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(1.6rem, 3vw, 2.2rem);margin:0 0 24px">Ready to Join KSRM?</h2><a href="mailto:hr@ksrmce.ac.in" class="car-cta-button">Contact HR Department</a></div></div></section></main><!--$--><!--/$--><footer style="width:100%;background:#1e2570;color:#ffffff;padding-top:56px"><style>
