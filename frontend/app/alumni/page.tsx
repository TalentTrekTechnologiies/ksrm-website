      ...
      <section
        ...
        style={{
          backgroundImage: `url('/banners/${
            { civil: 'civil', cse: 'cse', ece: 'ece', eee: 'eee', mechanical: 'mechanical', 'humanities-sciences': 'departments', mba: 'departments' }[department.slug] || 'departments'
          }.jpg')`,
        }}
      >
        <Container>
          <div style={{ padding: "40px 0", position: "relative", zIndex: 1 }}>
            <motion.div
              ...
              variants={stagger}
              style={{
                background: 'rgba(43, 52, 144, 0.85)',
