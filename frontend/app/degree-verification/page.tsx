  ...
  return (
    <main style={{ background: "#ffffff" }}>
      <style>{`
        ...
        .dv-hero { position: relative; background-image: url('/banners/degree-verification.webp'); background-size: cover; background-position: center; background-color: #f5f5f5; min-height: 280px; display: flex; align-items: flex-end; padding-bottom: 40px; overflow: hidden; }
