  ...
  return (
    <main style={{ background: "#ffffff" }}>
      <style>{`
        ...
        .dv-hero { position: relative; background-image: url('/banners/examinations-banner.jpg'); background-size: cover; background-position: center; background-color: #2B3490; min-height: 280px; display: flex; align-items: flex-end; padding-bottom: 40px; overflow: hidden; }
        .dv-hero::after { content: ''; position: absolute; inset: 0; background: linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.4) 100%); pointer-events: none; }
      ...
      <section style={{ padding: "48px 0", background: "#ffffff" }}>
        <div className="responsive-container">
          <div className="dv-about">
            <p>
              KSRM College of Engineering provides online degree verification services through iCredify platform.
