...
export default function AboutPage() {
  return (
    <main style={{ background: "#ffffff" }}>
      ...
      {/* SECTION 1: HERO */}
      <section className="hero-gradient section-first" style={{ paddingTop: 80, paddingBottom: 80 }}>
        <Container>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.p variants={fadeUp} className="hero-text">{aboutData.intro}</motion.p>
          </motion.div>
        </Container>
      </section>
      ...
      {/* SECTION 3: ABOUT KSRMCE */}
      <section className="section-bg-cream section-separator" id="about-ksrmce">
        <Container>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <h2 className="heading-main">About KSRMCE</h2>
            <motion.div variants={fadeUp} className="card-about">
              <h3>The Beginning</h3>
              <p style={{ margin: 0 }}>{aboutData.intro}</p>
            </motion.div>
            <motion.div variants={fadeUp} className="card-about">
              <h3>Development</h3>
              <p style={{ margin: 0 }}>{aboutData.development}</p>
            </motion.div>
            <motion.div variants={fadeUp} className="card-about">
              <h3>The Campus</h3>
              <p style={{ margin: 0 }}>{aboutData.campus}</p>
            </motion.div>
          </motion.div>
        </Container>
      </section>
