...
export const metadata: Metadata = pageMetadata({
  title: "Faculty Policies and Procedures",
  description: "Policies and procedures for faculty at K.S.R.M. College of Engineering, Kadapa - recruitment, appraisal, promotion, research and leave.",
