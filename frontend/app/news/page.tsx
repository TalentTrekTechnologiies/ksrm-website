...
export default function Page() {
  return (
    <div dangerouslySetInnerHTML={{
      ...
      </style><section class="news-hero"><style>
      ...
      </style><div class="responsive-container "><div style="padding:72px 0;position:relative;z-index:1"><div><div class="news-breadcrumb"><a href="/">Home</a><span>/</span><span>News &amp; Events</span></div><h1 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(2.2rem, 4.5vw, 3.6rem);font-weight:700;color:#fff;line-height:1.08;margin:0;opacity:0;transform:translateY(28px)">News &amp; Events</h1><p style="color:rgba(255,255,255,0.8);font-size:18px;line-height:1.6;margin:16px 0 0;font-weight:300;max-width:600px;opacity:0;transform:translateY(28px)">Stay updated with the latest from KSRM</p></div></div></div></section><section style="padding:48px 0;background:#ffffff"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div class="news-filters" style="opacity:0;transform:translateY(28px)"><button class="news-filter-btn active">All</button><button class="news-filter-btn ">Examinations</button><button class="news-filter-btn ">Events</button><button class="news-filter-btn ">Accreditation</button><button class="news-filter-btn ">Rankings</button><button class="news-filter-btn ">Placements</button></div></div></section><section style="padding:72px 0;background:#f7f8fa"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div class="news-grid"><div class="news-card" style="opacity:0;transform:translateY(28px)"><div class="news-badge" style="background:#eef1ff;color:#2B3490">Examinations</div><div class="news-new-badge">ðŸ†• NEW</div><div class="news-content"><span class="news-date">2026-05-15</span><h3 class="news-title">KGCET 2K26 Results Announced</h3><p class="news-description">KGCET 2026 results have been announced. Students can check their results at the official portal.</p><a href="https://ksrmce.ac.in/KGCET2K26-Results.pdf" class="news-read-more">Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div><div class="news-card" style="opacity:0;transform:translateY(28px)"><div class="news-badge" style="background:#fff3e0;color:#f57c00">Events</div><div class="news-new-badge">ðŸ†• NEW</div><div class="news-content"><span class="news-date">2026-04-01</span><h3 class="news-title">Graduation Day 2026 Applications Open</h3><p class="news-description">Applications for Graduation Day 2026 are now open. Students who have completed their degree can apply.</p><a href="#" class="news-read-more">Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div><div class="news-card" style="opacity:0;transform:translateY(28px)"><div class="news-badge" style="background:#fff3e0;color:#f57c00">Events</div><div class="news-content"><span class="news-date">2025-08-15</span><h3 class="news-title">Freshers Orientation 2025-26</h3><p class="news-description">Welcome to the new batch of 2025-26. Orientation program details have been announced.</p><a href="#" class="news-read-more">Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div><div class="news-card" style="opacity:0;transform:translateY(28px)"><div class="news-badge" style="background:#e8f5e9;color:#388e3c">Accreditation</div><div class="news-content"><span class="news-date">2025-06-01</span><h3 class="news-title">NBA Accreditation Renewed</h3><p class="news-description">KSRM College of Engineering has successfully renewed NBA accreditation for multiple programmes.</p><a href="#" class="news-read-more">Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div><div class="news-card" style="opacity:0;transform:translateY(28px)"><div class="news-badge" style="background:#fce4ec;color:#c2185b">Rankings</div><div class="news-content"><span class="news-date">2025-03-01</span><h3 class="news-title">NIRF Ranking 2025 Submitted</h3><p class="news-description">KSRM College has submitted its NIRF ranking data for 2025.</p><a href="https://ksrmce.ac.in/nirf.php" class="news-read-more">Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div><div class="news-card" style="opacity:0;transform:translateY(28px)"><div class="news-badge" style="background:#fff3e0;color:#f57c00">Events</div><div class="news-content"><span class="news-date">2024-12-10</span><h3 class="news-title">Industry-Academia Meet 2024</h3><p class="news-description">Annual Industry-Academia meet held with participation from 20+ companies.</p><a href="#" class="news-read-more">Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div></div></div></section></main><!--$--><!--/$--><footer style="width:100%;background:#1e2570;color:#ffffff;padding-top:56px"><style>
