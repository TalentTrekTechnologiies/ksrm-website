        ...
        <div className="k-container">
          ...
          <div className="k-charities-body">
            ...
            <figure className="k-charities-figure">
              ...
              <img src="/images/leadership/correspondent.webp" alt="Smt. K. Rajeswari, Correspondent" loading="lazy" decoding="async" />
            </figure>
          </div>
            ...
            {TRUSTEES.map((t, i) => (
              <div key={i} className="k-trustee">
                {t.photo ? (
                  ...
                  <img src={t.photo} alt={t.name} className="k-trustee-photo" loading="lazy" decoding="async" />
                ) : (
