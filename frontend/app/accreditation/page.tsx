...
export default function CampusFacilitiesTemplate() {
  ...
  return (
    <main style={{ background: "#ffffff" }}>
      ...
      {/* HERO */}
      <section className="cf-hero" style={{ backgroundImage: `url('/banners/hostel-banner.jpg')` }}>
        <Container>
          <motion.div
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            <div style={{
              ...
              {[
                ...
                <motion.div key={idx} variants={fadeUp} style={{ borderRadius: "8px", overflow: "hidden" }}>
          ...
          >
            ...
            <motion.div variants={stagger} className="cf-stats-bar">
              <motion.div variants={fadeUp} className="cf-stat-item">
                <div className="cf-stat-icon">ðŸ“</div>
