  ...
  return (
    <main style={{ background: "#ffffff" }}>
      <style>{`
        ...
        .hb-hero { position: relative; background-image: url('/banners/placements-training.webp'); background-size: cover; background-position: center; background-color: #2B3490; padding: 92px 0; overflow: hidden; }
      ...
      <section className="hb-hero">
        <div className="hb-container">
          <h1 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "clamp(2rem, 4.5vw, 3.4rem)", fontWeight: 700, color: "#fff", margin: 0 }}><CmsText section="placements" slot="placements" /></h1>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 18, margin: "14px 0 0", maxWidth: 720 }}><CmsText section="placements" slot="1200-students-placed-200-recruiting" /></p>
        </div>
      </section>
          ...
          <div className="hb-grid">
            {LINKS.map((l, _i) => (
              <Link key={l.href} href={l.href} className="hb-card">
                <h2 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 20, fontWeight: 700, color: "#1a1a2e", margin: "0 0 8px" }}><CmsText section="placements" slot={`LINKS.${_i}.label`} /></h2>
                <p style={{ color: "#666", fontSize: 15, lineHeight: 1.6, margin: 0 }}><CmsText section="placements" slot={`LINKS.${_i}.blurb`} /></p>
