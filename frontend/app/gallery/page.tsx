...
export default function Page() {
  return (
    <div dangerouslySetInnerHTML={{
      ...
      </style><section class="gal-hero"><style>
      ...
      </style><div class="responsive-container "><div><div class="gal-breadcrumb" style="margin-bottom:16px;text-shadow:0 2px 8px rgba(0,0,0,0.6)"><a href="/">Home</a><span>/</span><span>Gallery</span></div><h1 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(2.2rem, 4.5vw, 3.6rem);font-weight:700;color:#fff;line-height:1.08;margin:0;text-shadow:0 2px 12px rgba(0,0,0,0.7);opacity:0;transform:translateY(28px)">Campus Gallery</h1><p style="color:rgba(255,255,255,0.85);font-size:18px;line-height:1.6;margin:16px 0 0;font-weight:300;max-width:100%;text-shadow:0 2px 8px rgba(0,0,0,0.6);opacity:0;transform:translateY(28px)">Explore life at KSRM College of Engineering</p></div></div></section><section style="padding:48px 0;background:#ffffff"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div style="opacity:1;transform:none"><div class="gal-filters"><button class="gal-filter-btn active">All</button><button class="gal-filter-btn ">Campus</button><button class="gal-filter-btn ">Labs</button><button class="gal-filter-btn ">Sports</button><button class="gal-filter-btn ">Library</button><button class="gal-filter-btn ">Events</button><button class="gal-filter-btn ">Transport</button></div></div></div></section><section style="padding:72px 0;background:#f7f8fa"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div><div class="gal-grid"><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/campus/topview.jpg" alt="KSRM College aerial campus view" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">KSRM College aerial campus view</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Campus</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/campus/blocktop.jpg" alt="Main block aerial view" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Main block aerial view</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Campus</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/campus/block.jpg" alt="Main administrative block" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Main administrative block</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Campus</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/campus/19.jpg" alt="Solar powered campus" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Solar powered campus</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Campus</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/campus/22.jpg" alt="Solar parking facility" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Solar parking facility</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Campus</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/labs/lab.jpg" alt="Robotics laboratory with ABB robotic arm" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Robotics laboratory with ABB robotic arm</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Labs</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/labs/roboticslab.jpg" alt="Robotic 3D printing lab" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Robotic 3D printing lab</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Labs</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/labs/ab.jpg" alt="Computer laboratory" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Computer laboratory</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Labs</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/labs/labw.jpg" alt="Computer lab examination" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Computer lab examination</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Labs</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/labs/lab2.jpg" alt="Chemistry laboratory" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Chemistry laboratory</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Labs</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/labs/lab3.jpg" alt="Electrical engineering lab" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Electrical engineering lab</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Labs</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/sports/volleyball.jpg" alt="Volleyball match" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Volleyball match</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Sports</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/sports/sportsg3.jpg" alt="Indoor badminton court" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Indoor badminton court</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Sports</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/sports/sportsground.jpg" alt="Basketball court" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Basketball court</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Sports</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/sports/sportsground2.jpg" alt="Sports ground aerial view" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Sports ground aerial view</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Sports</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/library/library.jpg" alt="Central Library building" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Central Library building</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Library</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/library/studentsinlib.jpg" alt="Students reading in library" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Students reading in library</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Library</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/library/studentsinlib2.jpg" alt="Students studying in library" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Students studying in library</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Library</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/fest.jpg" alt="Award ceremony" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Award ceremony</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/fest2.jpg" alt="Cultural fest performance" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Cultural fest performance</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/event.jpg" alt="KGCET poster launch" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">KGCET poster launch</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/event2.jpg" alt="CONNECT 2K26 technical fest" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">CONNECT 2K26 technical fest</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/seminar.jpg" alt="Seminar in auditorium" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Seminar in auditorium</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/inaugaration.jpg" alt="Statue inauguration ceremony" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Statue inauguration ceremony</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/inaugaration2.jpg" alt="Event inauguration ribbon cutting" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Event inauguration ribbon cutting</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/achievements.jpg" alt="Achievement award" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Achievement award</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/activity.jpg" alt="College activity" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">College activity</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/activity2.jpg" alt="Campus tour activity" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus tour activity</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/activity3.jpg" alt="Bharat Environment Program" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Bharat Environment Program</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/events/activity4.jpg" alt="INSPIRON 2K26 event" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">INSPIRON 2K26 event</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00001.webp" alt="Campus event - day view" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus event - day view</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00007.webp" alt="Campus gathering and activities" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus gathering and activities</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00014.webp" alt="Students engaged in event" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Students engaged in event</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00016.webp" alt="Campus life moment" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus life moment</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00017.webp" alt="College event participation" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">College event participation</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00019.webp" alt="Campus event scene" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus event scene</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00027.webp" alt="Student activities on campus" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Student activities on campus</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00028.webp" alt="Event with student participation" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Event with student participation</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00048.webp" alt="Campus gathering and networking" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus gathering and networking</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00053.webp" alt="Event moment on campus" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Event moment on campus</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00058.webp" alt="Students at campus event" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Students at campus event</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00104.webp" alt="Campus celebration event" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus celebration event</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00116.webp" alt="Crowd at campus event" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Crowd at campus event</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00140.webp" alt="Event scene with students" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Event scene with students</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR00163.webp" alt="Large campus event gathering" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Large campus event gathering</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/hero/KSR09989.webp" alt="Campus activity highlight" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">Campus activity highlight</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Events</span></div></div></div><div class="gal-card" style="opacity:1;transform:none"><div class="gal-card-image" style="background:transparent;overflow:hidden;position:relative"><img src="/gallery/transport/buses.jpg" alt="KSRM college bus fleet" loading="lazy" style="width:100%;height:200px;object-fit:cover;transition:transform 0.3s ease"/><div class="gal-card-overlay"></div></div><div class="gal-card-content"><h3 class="gal-card-title">KSRM college bus fleet</h3><div class="gal-card-meta"><span style="color:#2B3490;font-weight:600">Transport</span></div></div></div></div></div></div></section><section style="padding:72px 0;background:#ffffff"><style>
        .responsive-container {
          width: 100%;
          max-width: 1400px;
          margin: 0 auto;
      ...
      </style><div class="responsive-container "><div><h2 style="font-family:&#x27;Rajdhani&#x27;, sans-serif;font-size:clamp(1.8rem, 3vw, 2.4rem);font-weight:700;color:#2B3490;margin:0 0 40px;opacity:0;transform:translateY(28px)">Campus Videos</h2><div style="display:grid;grid-template-columns:repeat(auto-fit, minmax(300px, 1fr));gap:24px;margin-top:40px"><div style="border-radius:8px;overflow:hidden;opacity:0;transform:translateY(28px)"><video autoPlay="" loop="" muted="" playsInline="" style="width:100%;aspect-ratio:16 / 9;object-fit:cover;display:block"><source src="/videos/flash-mob.mp4" type="video/mp4"/></video></div><div style="border-radius:8px;overflow:hidden;opacity:0;transform:translateY(28px)"><video autoPlay="" loop="" muted="" playsInline="" style="width:100%;aspect-ratio:16 / 9;object-fit:cover;display:block"><source src="/videos/3d-robo.mp4" type="video/mp4"/></video></div><div style="border-radius:8px;overflow:hidden;opacity:0;transform:translateY(28px)"><video autoPlay="" loop="" muted="" playsInline="" style="width:100%;aspect-ratio:16 / 9;object-fit:cover;display:block"><source src="/videos/sports-winners.mp4" type="video/mp4"/></video></div><div style="border-radius:8px;overflow:hidden;opacity:0;transform:translateY(28px)"><video autoPlay="" loop="" muted="" playsInline="" style="width:100%;aspect-ratio:16 / 9;object-fit:cover;display:block"><source src="/videos/sivananda-smaranam-night-event.mp4" type="video/mp4"/></video></div></div></div></div></section></main><!--$--><!--/$--><footer style="width:100%;background:#1e2570;color:#ffffff;padding-top:56px"><style>
