...
const images = [
  { src: "/gallery/campus/topview.jpg", alt: "KSRM College aerial campus view", cat: "Campus" },
  { src: "/gallery/campus/blocktop.jpg", alt: "Main block aerial view", cat: "Campus" },
  { src: "/gallery/campus/block.jpg", alt: "Main administrative block", cat: "Campus" },
  { src: "/gallery/campus/19.jpg", alt: "Solar powered campus", cat: "Campus" },
  { src: "/gallery/campus/22.jpg", alt: "Solar parking facility", cat: "Campus" },
  { src: "/gallery/labs/lab.jpg", alt: "Robotics laboratory with ABB robotic arm", cat: "Labs" },
  { src: "/gallery/labs/roboticslab.jpg", alt: "Robotic 3D printing lab", cat: "Labs" },
  { src: "/gallery/labs/ab.jpg", alt: "Computer laboratory", cat: "Labs" },
  { src: "/gallery/labs/labw.jpg", alt: "Computer lab examination", cat: "Labs" },
  { src: "/gallery/labs/lab2.jpg", alt: "Chemistry laboratory", cat: "Labs" },
  { src: "/gallery/labs/lab3.jpg", alt: "Electrical engineering lab", cat: "Labs" },
  { src: "/gallery/sports/volleyball.jpg", alt: "Volleyball match", cat: "Sports" },
  { src: "/gallery/sports/sportsg3.jpg", alt: "Indoor badminton court", cat: "Sports" },
  { src: "/gallery/sports/sportsground.jpg", alt: "Basketball court", cat: "Sports" },
  { src: "/gallery/sports/sportsground2.jpg", alt: "Sports ground aerial view", cat: "Sports" },
  { src: "/gallery/library/library.jpg", alt: "Central Library building", cat: "Library" },
  { src: "/gallery/library/studentsinlib.jpg", alt: "Students reading in library", cat: "Library" },
  { src: "/gallery/library/studentsinlib2.jpg", alt: "Students studying in library", cat: "Library" },
  { src: "/gallery/events/fest.jpg", alt: "Award ceremony", cat: "Events" },
  { src: "/gallery/events/fest2.jpg", alt: "Cultural fest performance", cat: "Events" },
  { src: "/gallery/events/event.jpg", alt: "KGCET poster launch", cat: "Events" },
  { src: "/gallery/events/event2.jpg", alt: "CONNECT 2K26 technical fest", cat: "Events" },
  { src: "/gallery/events/seminar.jpg", alt: "Seminar in auditorium", cat: "Events" },
  { src: "/gallery/events/inaugaration.jpg", alt: "Statue inauguration ceremony", cat: "Events" },
  { src: "/gallery/events/inaugaration2.jpg", alt: "Event inauguration ribbon cutting", cat: "Events" },
  { src: "/gallery/events/achievements.jpg", alt: "Achievement award", cat: "Events" },
  { src: "/gallery/events/activity.jpg", alt: "College activity", cat: "Events" },
  { src: "/gallery/events/activity2.jpg", alt: "Campus tour activity", cat: "Events" },
  { src: "/gallery/events/activity3.jpg", alt: "Bharat Environment Program", cat: "Events" },
  { src: "/gallery/events/activity4.jpg", alt: "INSPIRON 2K26 event", cat: "Events" },
  { src: "/hero/KSR00001.webp", alt: "Campus event - day view", cat: "Events" },
  { src: "/hero/KSR00007.webp", alt: "Campus gathering and activities", cat: "Events" },
  { src: "/hero/KSR00014.webp", alt: "Students engaged in event", cat: "Events" },
  { src: "/hero/KSR00016.webp", alt: "Campus life moment", cat: "Events" },
  { src: "/hero/KSR00017.webp", alt: "College event participation", cat: "Events" },
  { src: "/hero/KSR00019.webp", alt: "Campus event scene", cat: "Events" },
  { src: "/hero/KSR00027.webp", alt: "Student activities on campus", cat: "Events" },
  { src: "/hero/KSR00028.webp", alt: "Event with student participation", cat: "Events" },
  { src: "/hero/KSR00048.webp", alt: "Campus gathering and networking", cat: "Events" },
  { src: "/hero/KSR00053.webp", alt: "Event moment on campus", cat: "Events" },
  { src: "/hero/KSR00058.webp", alt: "Students at campus event", cat: "Events" },
  { src: "/hero/KSR00104.webp", alt: "Campus celebration event", cat: "Events" },
  { src: "/hero/KSR00116.webp", alt: "Crowd at campus event", cat: "Events" },
  { src: "/hero/KSR00140.webp", alt: "Event scene with students", cat: "Events" },
  { src: "/hero/KSR00163.webp", alt: "Large campus event gathering", cat: "Events" },
  { src: "/hero/KSR09989.webp", alt: "Campus activity highlight", cat: "Events" },
  { src: "/gallery/transport/buses.jpg", alt: "KSRM college bus fleet", cat: "Transport" },
  ...
  return (
    <main style={{ background: "#ffffff" }}>
      <style>{`
        ...
        .gal-hero { position: relative; background-image: url('/gallery/sports/sportsground2.jpg'); background-size: cover; background-position: center; background-color: #2B3490; min-height: 280px; display: flex; align-items: flex-end; padding-bottom: 40px; overflow: hidden; }
